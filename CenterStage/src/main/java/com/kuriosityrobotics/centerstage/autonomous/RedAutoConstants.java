...
public class RedAutoConstants {
	...
	public static final double INTAKE_X_3 = 88 * CM;
	...
	public static final Pose BOARD_POSE_RIGHT = new Pose(303 * CM, 75 * CM, toRadians(-180));
	public static final Pose BOARD_POSE_CENTER = new Pose(303 * CM, 91 * CM, toRadians(-180));
	public static final Pose BOARD_POSE_LEFT = new Pose(303 * CM, 110 * CM, toRadians(-180));

	public static final Pose INTAKE_POSE_1 = new Pose(INTAKE_ALIGN_X, INTAKE_1_Y, toRadians(-205));
	public static final Pose INTAKE_POSE_2 = new Pose(INTAKE_ALIGN_X, INTAKE_2_Y, toRadians(-180));
	public static final Pose INTAKE_POSE_3 = new Pose(INTAKE_X_3, INTAKE_3_Y, toRadians(-185));
	...
	// spike paths
	public static final double CENTER_Y = 90 * CM;
	public static final double HORIZONTAL_SPIKE_Y = 85 * CM;

	public static final Pose FIELD_LEFT_SPIKE = new Pose(86 * CM, HORIZONTAL_SPIKE_Y, toRadians(-30));
	public static final Pose FIELD_CENTER_SPIKE = new Pose(89 * CM, CENTER_Y, toRadians(-90));
	public static final Pose FIELD_RIGHT_SPIKE = new Pose(95 * CM, HORIZONTAL_SPIKE_Y, toRadians(-150));

	public static final Pose BOARD_LEFT_SPIKE = new Pose(205 * CM, HORIZONTAL_SPIKE_Y, toRadians(-30));
	public static final Pose BOARD_CENTER_SPIKE = new Pose(211 * CM, CENTER_Y, toRadians(-90));
	public static final Pose BOARD_RIGHT_SPIKE = new Pose(214 * CM, HORIZONTAL_SPIKE_Y, toRadians(-150));
	...
	private static Pose fieldCoordinateFor(SpikeLocation spike) {
		switch (spike){
			case LEFT:
				return FIELD_LEFT_SPIKE;
			case CENTER:
				return FIELD_CENTER_SPIKE;
			default:
	...
	public static DriveRecord fieldToSpike(SpikeLocation spike){
		...
		Pose spikePosition = fieldCoordinateFor(spike);
	...
	public static DriveRecord fieldSpikeToCorner(SpikeLocation spike) {
		...
		return new DriveRecord.Builder(spikePosition)
			...
			.goTo(FIELD_SPIKE_JUNCTION)
			.goToSlowly(new Pose(80 * CM, GUTTER_Y, toRadians(-180)))
			.goTo(new Pose(230 * CM, GUTTER_Y, toRadians(-180)))
			.goToQuickly(CORNER)
			.build();
	}

	public static Pose boardPositionFromSpike(SpikeLocation spike){
		switch (spike) {
			case LEFT:
	...
	public static DriveRecord cornerToDeposit(SpikeLocation spike) {
		Pose pose = boardPositionFromSpike(spike);
	...
	public static DriveRecord depositToBackstage(SpikeLocation spike) {
		...
		return new DriveRecord.Builder(pose)
			.goTo(new Pose(280 * CM, 70 * CM, toRadians(-180)))
			.goToSlowly(new Pose(280 * CM, GATE_Y, toRadians(-180)))
			.goToQuickly(BACKSTAGE)
			.build();
	}
